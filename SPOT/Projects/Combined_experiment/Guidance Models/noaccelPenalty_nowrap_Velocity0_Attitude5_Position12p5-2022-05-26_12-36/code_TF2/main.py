...
if Settings.RESUME_TRAINING and Settings.ENVIRONMENT == 'manipulator':
    ...
    try:
        ...
        for tensorboard_entry in tf.compat.v1.train.summary_iterator("../" + old_tensorboard_filename):
...
if Settings.ENVIRONMENT != 'fixedICs':
    writer = tf.compat.v1.summary.FileWriter(Settings.MODEL_SAVE_DIRECTORY + filename, filename_suffix = Settings.TENSORBOARD_FILE_EXTENSION)
else:
    writer = 0
