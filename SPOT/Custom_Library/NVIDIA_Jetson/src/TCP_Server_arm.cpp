...
void run_guidance(const double input_1, const double input_2,
                    ...
                    const double input_13, const double input_14,
                    const double input_15, const double input_16,
                    const double input_17, const double input_18,
                    const double input_19, double* output_1,
                    double* output_2, double* output_3,
                    double* output_4, double* output_5,
                    double* output_6, double* output_7)
{
    ...
    if (client_socket_fd < 0)
    {
       ...
       stringMessageOut = std::to_string(input_1) + "\n" + 
                           ...
                           std::to_string(input_14) + "\n" +
                           std::to_string(input_15) + "\n" +
                           std::to_string(input_16) + "\n" +
                           std::to_string(input_17) + "\n" +
                           std::to_string(input_18) + "\n" +
                           std::to_string(input_19) + "\n";
       ...
       *output_3 = atof(out.c_str());
       ...
       std::getline(ss, out, '\n');
       *output_4 = atof(out.c_str());

       std::getline(ss, out, '\n');
       *output_5 = atof(out.c_str());

       std::getline(ss, out, '\n');
       *output_6 = atof(out.c_str());
	   
	   std::getline(ss, out, '\n');
       *output_7 = atof(out.c_str());
