...
class Saver:
    ...
    def load(self):
        ...
        self.saver = tf.compat.v1.train.Saver(max_to_keep = Settings.NUM_CHECKPOINT_MODELS_TO_SAVE) # initialize the tensorflow Saver()
    ...
    def initialize(self):
        self.saver = tf.compat.v1.train.Saver(max_to_keep = Settings.NUM_CHECKPOINT_MODELS_TO_SAVE) # initialize the tensorflow Saver() without trying to load in parameters